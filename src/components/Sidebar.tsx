  ...
  return (
    <aside className="fixed left-0 top-0 h-full w-[280px] bg-surface-container-lowest border-r border-outline-variant shadow-sm flex flex-col p-6 z-50">
      <Link href="/startups" className="mb-10 px-2 block hover:opacity-80 transition-opacity">
        ...
        <img alt="PU-iNCENT Logo" className="h-10 w-auto mb-2 show-in-dark" src="/images/logo-dark.png" onError={(e) => { e.currentTarget.src = "https://lh3.googleusercontent.com/aida-public/AB6AXuBDw8RG7islAC7a6nT-0wWr4MtgLNuO7ra0O_KkizFiA0MRlf5v8b7PLjcdbppYtD7MCSUgOVNtbKv6ogzV3ZqKlJUCARmPuHjDiBoEqWAtUq9Jv4cf3iqjghXJRg-DCa_xX4hadln40Ei9jaCUVj1qhWvP-J-G-7kd9fl1f82c3CHKhcihzB3pVAj64CMJHPb-sfKoxJzmBOrdOLGGwEqQzsVvR5SSS6GxqlV-WQTn4I9TPjF9TA-puqWETFPRu3RgaP6rh-ihHKnz" }} />
      ...
      {session && (
        <div className="mt-auto pt-6 border-t border-outline-variant">
          <div className="flex items-center justify-between p-2">
            ...
            <button 
              onClick={() => signOut()}
              className="w-8 h-8 flex items-center justify-center rounded-lg hover:bg-red-500/10 text-red-500 transition-colors"
              title="Logout"
            >

...
export default function Sidebar() {
  ...
  return (
    <>
      ...
      <aside 
        className={`fixed left-0 top-0 h-full w-[280px] bg-surface-container-lowest border-r border-outline-variant shadow-sm flex flex-col p-6 z-50 transition-transform duration-300 ease-in-out ${
          isOpen ? 'translate-x-0' : '-translate-x-full lg:translate-x-0'
        }`}
      >
        <Link href="/startups" className="mb-10 px-2 block hover:opacity-80 transition-opacity" onClick={close}>
